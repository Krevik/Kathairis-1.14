...
public class BiomeKatharianHugeDesertMountains extends BiomeKatharianBiomeBase{
    ...
    public BiomeKatharianHugeDesertMountains() {
        ...
        super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SAND_SAND_SANDSTONE_SURFACE).precipitation(Biome.RainType.NONE).category(Biome.Category.DESERT).depth(1.8F).scale(2F).temperature(2.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent((String)null));
