...
public class EntityPhasm extends FlyingEntity implements IMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(5, new EntityPhasm.AIWander(this));
        this.goalSelector.addGoal(2,new EntityPhasm.AILookAtTheFuckingPlayer(this));
        this.goalSelector.addGoal(3, new EntityPhasm.AIInteractWithPlayer(this));
    }
