...
public class EntityGaznowel extends FlyingEntity implements IRangedAttackMob, IMob {
    ...
    public EntityGaznowel(World worldIn)
    {
        ...
        this.moveController = new EntityGaznowel.GaznowelMoveHelper(this);
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new EntityGaznowel.AIInteractWithPlayer(this));
        this.goalSelector.addGoal(2, new EntityGaznowel.AIWander(this));
    }
